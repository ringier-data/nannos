...
ALL_PACKAGES="agent-creator agent-runner orchestrator-agent console-backend console-frontend ringier-a2a-sdk object-storage client-slack client-slack-frontend client-email voice-agent client-google-chat soffice-worker"
...
pkg_type() {
  case "$1" in
    ...
    agent-creator|agent-runner|orchestrator-agent|console-backend|catalog-worker|ringier-a2a-sdk|object-storage|voice-agent|soffice-worker) echo "python" ;;
    *) echo "ERROR: Unknown package '$1'" >&2; return 1 ;;
  esac
}

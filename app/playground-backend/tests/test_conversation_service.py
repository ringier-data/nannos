...
async def test_get_conversation_with_composite_key(conversation_service):
    ...
    result = await conversation_service.get_conversation(
        '01900000-0000-7000-8000-000000000001', 'user1'
    )
    ...
    result_wrong_user = await conversation_service.get_conversation(
        '01900000-0000-7000-8000-000000000001', 'user2'
    )
    assert result_wrong_user is None

    # Test that non-existent conversation returns None
    result_not_found = await conversation_service.get_conversation(
        '01900000-0000-7000-8000-000000000999', 'user1'
    )

...
class TestRegistryService:
    ...
    async def test_get_user_success_with_remote_agents(self, registry_service):
            ...
            "items": [
                {
                    ...
                    "status": "approved",
                    "model": None,
                    "configuration": {"agent_url": "https://jira-agent.example.com/a2a"},
                }
            ],
            "total": 1,
        }
        ...
        with patch.object(registry_service, "_get_client") as mock_get_client:
            ...
            assert len(user.agent_urls) == 1
            assert user.agent_urls[0] == "https://jira-agent.example.com/a2a"
    ...
    async def test_get_user_success_with_local_agents(self, registry_service):
        ...
        with patch.object(registry_service, "_get_client") as mock_get_client:
            ...
            assert local_agent.mcp_gateway_url == "https://mcp.example.com"
            ...
            "items": [
                {
                    ...
                    "type": "remote",
                    "status": "approved",
                    "configuration": {"agent_url": "https://jira.example.com/a2a"},
                },
                {
                    "id": 2,
                    "name": "slack-agent",
                    ...
                    "type": "remote",
                    "status": "approved",
                    "configuration": {"agent_url": "https://slack.example.com/a2a"},
                },
                {
                    "id": 3,
                    "name": "code-reviewer",
                    ...
                    "type": "local",
                    "status": "approved",
                    "configuration": {"system_prompt": "Review code for issues."},
                },
            ],
            "total": 3,
        }
...
class TestUserModel:
    ...
    def test_user_with_values(self):
        ...
        local_agent = LocalSubAgentConfig(
            name="test-agent",
        ...
        user = User(
            id="test-id",
            agent_urls=["https://agent1.example.com", "https://agent2.example.com"],

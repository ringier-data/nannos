...
class TestAgentStreamResponse:
    ...
    def test_with_metadata(self):
        ...
        response = AgentStreamResponse(
            ...
            metadata={"task_id": "123", "duration": 5.2}
        )
    ...
    def test_working_factory(self):
        ...
        response = AgentStreamResponse.working(
            "Processing step 1",
            step=1,
            total=5
        )
    ...
    def test_completed_factory(self):
        ...
        response = AgentStreamResponse.completed(
            "Task successful",
            result_count=42
        )
    ...
    def test_failed_factory(self):
        ...
        response = AgentStreamResponse.failed(
            "Operation failed",
            error_code="ERR_500"
        )
    ...
    def test_input_required_factory(self):
        ...
        response = AgentStreamResponse.input_required(
            ...
            pending_nodes=["user_input", "validation"],
            field="name"
        )
...
class TestAgentStreamResponseFactoryMethods:
    ...
    def test_factory_methods_return_correct_type(self):
        ...
        assert isinstance(
            AgentStreamResponse.auth_required("test", "url", "code"),
            AgentStreamResponse
        )
        assert isinstance(
            AgentStreamResponse.working("test"),
            AgentStreamResponse
        )
        assert isinstance(
            AgentStreamResponse.completed("test"),
            AgentStreamResponse
        )
        assert isinstance(
            AgentStreamResponse.failed("test"),
            AgentStreamResponse
        )
        assert isinstance(
            AgentStreamResponse.input_required("test"),
            AgentStreamResponse
        )

...
class UserConfig(BaseModel):
    ...
    whoami: str = Field(..., description="User identifier")
    token: SecretStr = Field(..., description="User authentication token")
...
class AgentSettings:
    ...
    @classmethod
    def get_gatana_api_key(cls) -> str:
        """Get Gatana API key for MCP tools."""
        return os.environ['GATANA_API_KEY']

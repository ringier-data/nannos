...
def make_a2a_async_runnable(
    ...
    *,
    ...
    Args:
        ...
        user_token: User's authenticated JWT token (required for OAuth2 agents)
    ...
    if user_token:
        ...
        logger.info(
            f"No user_token provided for {agent_card.name}. "
            "Agent will be called without authentication."
        )

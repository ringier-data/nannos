...
class A2AClientRunnable:
    ...
    def _parse_auth_payload(self, task_status) -> Dict[str, Any]:
        ...
        service_auth_requirement = ServiceAuthRequirement(
            ...
            auth_methods=[AuthenticationMethod(**method) for method in auth_methods] if auth_methods else [
                AuthenticationMethod(
                    method="oauth2",
        ...
        return {
            ...
            "device_code_supported": any(method.method == "device_code" for method in service_auth_requirement.auth_methods),
    ...
    async def ainvoke(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "messages": [AIMessage(content="The requested service is currently unavailable. Please try again later.")],
            }
    ...
    def stream(self, input_data: Dict[str, Any]):
        ...
        raise NotImplementedError(
            "Synchronous streaming not supported for A2A. Use astream() instead."
        )
    ...
    def _extract_tracking_ids(self, input_data: SubAgentInput) -> tuple[Optional[str], Optional[str]]:
        ...
        if not agent_tracking:
            logger.warning(f"No tracking found for agent: {agent_name}. Available: {list(input_data.a2a_tracking.keys())}")

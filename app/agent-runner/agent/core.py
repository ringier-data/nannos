...
def _create_checkpointer() -> DynamoDBSaver:
    """Create a DynamoDB checkpointer using environment configuration."""
    checkpoint_table = os.environ["CHECKPOINT_DYNAMODB_TABLE_NAME"]

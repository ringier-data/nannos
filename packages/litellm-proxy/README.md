...
exact version (**v1.90.7** — bumped from v1.89.2 via v1.90.0-rc.1 for the Vertex multi-region
context-caching fix, BerriAI/litellm#29573, then to v1.90.7 for the GHSA-3cv6-jpf6-8222 backport;
see the Dockerfile). On a materially different version the

"""
Factory for creating A2A client runnables with automatic authentication.

This module provides factory functions for creating A2AClientRunnable instances
with proper authentication configuration. It decouples the authentication setup
from the A2AClientRunnable itself, allowing different auth strategies.
...
from agent_common.a2a.authentication.interceptor import SmartTokenInterceptor
...
def make_a2a_async_runnable(
    ...
    *,
    ...
    Args:
        ...
        oauth2_client: OAuth2 client for token exchange
    ...
    Returns:
        An A2AClientRunnable that can be used with LangChain, supporting async execution

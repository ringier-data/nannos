 ...
 */
export const playgroundGrepMcpTools = <ThrowOnError extends boolean = false>(options: Options<PlaygroundGrepMcpToolsData, ThrowOnError>) => (options.client ?? client).get<PlaygroundGrepMcpToolsResponses, PlaygroundGrepMcpToolsErrors, ThrowOnError>({ url: '/api/v1/mcp/tools/search', ...options });
 ...
 * 503 Service Unavailable: If MCP gateway is unreachable
 */
export const playgroundListMcpTools = <ThrowOnError extends boolean = false>(options?: Options<PlaygroundListMcpToolsData, ThrowOnError>) => (options?.client ?? client).get<PlaygroundListMcpToolsResponses, PlaygroundListMcpToolsErrors, ThrowOnError>({ url: '/api/v1/mcp/tools', ...options });
 ...
 */
export const playgroundListMcpServers = <ThrowOnError extends boolean = false>(options?: Options<PlaygroundListMcpServersData, ThrowOnError>) => (options?.client ?? client).get<PlaygroundListMcpServersResponses, unknown, ThrowOnError>({ url: '/api/v1/mcp/servers', ...options });

...
export const fr: NannosStrings = {
  ...
  'thread.activityApproved': '{count} approuvée(s)',
  'thread.activityRejected': '{count} refusée(s)',
  'thread.thinking': 'réflexion',
  'thread.pendingOne': '1 approbation en attente',
  'thread.pendingMany': '{count} approbations en attente',
  ...
  'receipt.approved': '{subject} approuvé',
  'receipt.rejected': '{subject} refusé',
  'receipt.changes': 'Modifications demandées pour {subject}',
  'receipt.batch': '{approved} action(s) sur {total} approuvée(s)',

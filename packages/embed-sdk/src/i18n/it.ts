...
export const it: NannosStrings = {
  ...
  'thread.activitySteps': '{count} passaggi eseguiti',
  'thread.activityStep': '1 passaggio eseguito',
  'thread.activityApproved': '{count} approvate',
  'thread.activityRejected': '{count} rifiutate',
  'thread.thinking': 'ragionamento',
  'thread.pendingOne': '1 approvazione in attesa',
  'thread.pendingMany': '{count} approvazioni in attesa',
  'conversations.title': 'Conversazioni',
  'conversations.search': 'Cerca conversazioni…',
  'conversations.hide': 'Nascondi conversazioni',
  'conversations.show': 'Mostra conversazioni',
  ...
  'hitl.titleCount': '{count} approvazioni necessarie',
  ...
  'receipt.approved': '{subject} approvato',
  'receipt.rejected': '{subject} rifiutato',
  'receipt.changes': 'Modifiche richieste per {subject}',
  'receipt.batch': '{approved} azioni su {total} approvate',
  'receipt.batchRejected': '{rejected} rifiutate',
  'receipt.authorized': '{subject} autorizzato',
  'receipt.skipped': 'Autorizzazione per {subject} saltata',

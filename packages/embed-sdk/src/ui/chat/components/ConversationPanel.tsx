...
export interface ConversationPanelProps {
  /** Layout override for non-sidebar placements (e.g. the compact widget's
   *  history overlay renders it full-width without the sidebar border). */
  className?: string;
  /** Called after the user picks or creates a conversation — lets an overlay
   *  host close itself. */
  onConversationSelected?: () => void;
}

export function ConversationPanel({ className, onConversationSelected }: ConversationPanelProps = {}) {

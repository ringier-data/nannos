...
// Pure A2A protocol helpers live in the Embed SDK core (single source of truth
// for the widget and console); re-exported here so `./utils` importers are
// unchanged. Presentational/DOM helpers stay in this file.

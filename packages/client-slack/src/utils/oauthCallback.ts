...
const CALLBACK_TEXT = {
  en: {
    ...
    successBody: 'You can now use the Slack bot.',
  ...
  de: {
    ...
    successBody: 'Sie können den Slack-Bot jetzt verwenden.',
    closeHint: 'Sie können dieses Fenster schliessen.',
    back: 'Zurück zu Slack',
  ...
  fr: {
    ...
    successBody: 'Vous pouvez maintenant utiliser le bot Slack.',
  ...
  it: {
    ...
    successBody: 'Ora puoi usare il bot Slack.',

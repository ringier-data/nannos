    ...
    *,
    ...
    try:
        while True:
            ...
            # The pending task completed; consume it and prepare for the next item.
            task = pending
            pending = None
            try:
                item = task.result()
        ...
        # Always cancel/clean up the in-flight task if we leave the loop while it
        # is still pending (stall hard cap, generator close, or exception).
